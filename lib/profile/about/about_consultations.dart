...
class AboutConsultations extends StatefulWidget {
  const AboutConsultations({super.key});

  @override
  State<AboutConsultations> createState() => _AboutConsultationsState();
}

class _AboutConsultationsState extends State<AboutConsultations> {
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      S.of(context).aboutconsultations,
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 15.sp,
