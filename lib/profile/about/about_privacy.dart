...
class AboutPrivacy extends StatefulWidget {
  const AboutPrivacy({super.key});

  @override
  State<AboutPrivacy> createState() => _AboutPrivacyState();
}

class _AboutPrivacyState extends State<AboutPrivacy> {
