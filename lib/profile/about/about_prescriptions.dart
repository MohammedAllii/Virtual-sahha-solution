...
class AboutPrescriptions extends StatefulWidget {
  const AboutPrescriptions({super.key});

  @override
  State<AboutPrescriptions> createState() => _AboutPrescriptionsState();
}

class _AboutPrescriptionsState extends State<AboutPrescriptions> {
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      S.of(context).aboutprescriptions,
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 15.sp,
