...
class Pharmaceutique extends StatefulWidget {
  const Pharmaceutique({super.key});

  @override
  State<Pharmaceutique> createState() => _pharmaceutiqueState();
...
class _pharmaceutiqueState extends State<Pharmaceutique> {
                            ...
                            _medicalExams.isEmpty
                                ...
                                : ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    final exam = _medicalExams[index];
                                    return Padding(
